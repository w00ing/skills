...
description: Polish, rewrite, or review German public copy so it sounds natural to German readers while preserving meaning, verified product claims, search intent, and the established product voice. Use for de landing pages, metadata, CTAs, FAQs, blog/changelog prose, translation polish, "AI-sounding German", "KI-Text", "Deutsch humanisieren", "Übersetzungsdeutsch", "Anglizismen entfernen", or German copy QA before publishing.
---

# Humanize German

Use this skill for German copy polish, especially public-facing product copy.
